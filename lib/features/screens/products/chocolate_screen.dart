...
class ChocolateScreen extends StatefulWidget {
  ...
  const ChocolateScreen({super.key, required this.categoryTitle});

  @override
  State<ChocolateScreen> createState() => _ChocolateScreenState();
}
  ...
  Future<void> _fetchProductos() async {
    try {
      ...
      List<GeneralModels.ProductModel> productos =
          await _apiService.obtenerProductosPorCategoriaId(9);
  ...
  void _addToCart(GeneralModels.ProductModel producto) {
    ...
    final config = ObleaConfiguration()
      ...
      ..ingredientesPersonalizados = {
        ...
        'Categoría': producto.nombreCategoria ?? 'Chocolate',
      };
